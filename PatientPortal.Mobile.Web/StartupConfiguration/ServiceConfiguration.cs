...
namespace PatientPortal.Mobile.Web.StartupConfiguration
{
    ...
    {
        const string TokenIssuer = "PatientPortal.Mobile.Web";
        ...
        static void RegisterDependencies(this IServiceCollection services, IConfiguration Configuration)
        {
            ...
            var opt = new DbContextOptionsBuilder<PatientPortalMobileContext>()
                .UseSqlServer(Configuration.GetConnectionString("PatientPortalMobileDatabase"))
                .Options;
            services.AddSingleton<Func<PatientPortalMobileContext>>
            (
                () => new PatientPortalMobileContext(opt)
            );
        ...
        static void AddSwagger(this IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "PatientPortal Mobile API",
                    Version = "v1",
                    Description = "Api's created for PatientPortal Mobile application. Not authorized currently."
                });
