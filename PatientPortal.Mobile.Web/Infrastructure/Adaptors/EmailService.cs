...
namespace PatientPortal.Mobile.Web.Infrastructure.Adaptors
{
    public class EmailService : IEmailService
    {
        ...
        private const string _twoFaMailSubject = "PatientPortal Two Factor Authentication";
        private const string _deviceVerificationMailSubject = "PatientPortal Device Verification";
        private const string _forgetPasswordMailSubject = "PatientPortal Forget Password";
