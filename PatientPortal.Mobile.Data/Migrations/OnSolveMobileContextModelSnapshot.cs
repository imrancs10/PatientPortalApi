...
namespace PatientPortal.Mobile.Data.Migrations
{
    [DbContext(typeof(PatientPortalMobileContext))]
    partial class PatientPortalMobileContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PatientPortal.Mobile.Data.Entites.ConferenceBridgeDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("PatientPortal.Mobile.Data.Entites.EmailVerificationCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("PatientPortal.Mobile.Data.Entites.FCMTokenInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("PatientPortal.Mobile.Data.Entites.MessageDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("PatientPortal.Mobile.Data.Entites.MessageSenderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("PatientPortal.Mobile.Data.Entites.MobileRecipient", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("PatientPortal.Mobile.Data.Entites.MobileUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("PatientPortal.Mobile.Data.Entites.ResetPasswordCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("PatientPortal.Mobile.Data.Entites.FCMTokenInfo", b =>
                {
                    b.HasOne("PatientPortal.Mobile.Data.Entites.MobileUser", "MobileUser")
            ...
            modelBuilder.Entity("PatientPortal.Mobile.Data.Entites.MessageDetail", b =>
                {
                    b.HasOne("PatientPortal.Mobile.Data.Entites.ConferenceBridgeDetail", "ConferenceBridgeDetail")
                        .WithMany()
                        .HasForeignKey("ConferenceBridgeDetailId");

                    b.HasOne("PatientPortal.Mobile.Data.Entites.MessageSenderDetail", "MessageSenderDetail")
                        .WithMany()
